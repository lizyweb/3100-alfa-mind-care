...
<head>
  ...
  <style>
    ...
    <style>
        .cta {
            background: linear-gradient(to right,rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url("img/image-1/img-2.jpg") fixed center center;
        ...
        <div class="container">
            <div class="row d-flex align-items-center justify-content-center">
                <div class="col-md-6 contact">
                    <h3 class="mb-3 text-white">Search Patients</h3>
                    <form action="search_results.php" method="get">
                        ...
                        <input type="submit" value="Search" class="btn_1 mt-3">
                    </form>
                </div>
            </div>
            <br>
